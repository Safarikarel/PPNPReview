...
\providecommand{\nb}{\mbox{\,\mathrm{mb}}}
\newcommand {\naive}    {na\"{\i}ve}
\newcommand{\PHOJET} {{{PHOJET}}}
\newcommand{\HYDJET}{{{HYDJET}}}
\newcommand{\PYTHYD}{{{PYTHIA+HYDJET}}}
...
\providecommand{\rjg}{\ensuremath{R_{\mathrm{J}\Pgg}}}
\providecommand{\xjg}{\ensuremath{x_{\mathrm{J}\Pgg}}}
\providecommand{\sjg}{\ensuremath{\sigma(\Delta\varphi_{\mathrm{J}\Pgg})}}
\providecommand{\ptg}{\ensuremath{p_{\mathrm{T},\Pgg}}}
\providecommand{\dphijg}{\ensuremath{\Delta\varphi_{\mathrm{J}\Pgg}}}
\providecommand{\avexjg}{\ensuremath{\langle x_{\mathrm{J}\Pgg}\rangle}}
\providecommand{\sigeta}{\ensuremath{\sigma_{\eta\eta}}}

\providecommand {\mubinv}{\ensuremath{\mathrm{\mu b^{-1}}}}
\providecommand {\nbinv}{\ensuremath{\mathrm{nb^{-1}}}}
\providecommand{\PHOJET} {{PHOJET}}
\newcommand {\dNdxsi} {\ensuremath{{\rd}N_{\mathrm{track}}/{\rd}\xi}}
...
\newcommand{\PgUn}{\ensuremath{\Upsilon\mathrm{(nS)}}}
