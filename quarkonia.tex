...
~\cite{Alessandro:2004ap,Adare:2006ns,Adare:2011yf}.
...
collisions at $\rootsNN = 2.76$\TeV\ as a function of  rapidity for two $p_{\rm{t}}$ ranges.
...
for  nDSg (shaded areas) and EPS09 (lines) nPDFs.}
\end{center}
\end{figure}

Within uncertainties, neither \pT\ range shows a strong dependence of \jpsi\ suppression on rapidity.
The suppression is stronger than predicted for shadowing effects in the Color Singlet Model
