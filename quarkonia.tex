...
A stronger initial state suppression has been obtained in the Color Glass Condensate 
(CGC) model~\cite{Dominguez:2011cy},
...
In contrast, possible \jpsi\ regeneration effects in statistical 
hadronization~\cite{{BraunMunzinger:2000px, Thews:2000rj}}
...
Data from ALICE and CMS on the \pT\ dependence of the \jpsi\ \Raa\ integrated over a 
wide range of \PbPb\ collision centrality
