...
$\eta/s = 1/4\pi$.  The RHIC experimental data suggest values of 1-2 times this bound, although estimates are limited
...
%
Another method is to use multi-particle cumulants to explicitly remove lower order correlations.
...
the event-wise random positions of nucleons in each nuclei, several more years elapsed before it was suggested
to look for higher-order harmonic flow, particularly odd-orders~\cite{Alver:2010gr}.
