...
\begin{figure}[thb]
\begin{center}
\includegraphics[width=0.8\mboxwidth]{jetfigures/final_4x2_23_newpp.pdf}
\caption{
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.6\mboxwidth]{jetfigures/dijet_imbalance5_0to20_pt_20120103_subt.pdf}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.6\mboxwidth]{jetfigures/deltaPtOverPt5_lead120_sub30_diff_20120103.pdf}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.8\mboxwidth]{jetfigures/xsi_div_both_effv9_l100s40_0to12_dphi20eta20dr3pt4id1_cwt_ppDiv_gray.pdf}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.98\mboxwidth]{jetfigures/JetShapes_GR.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\mboxwidth]{jetfigures/missingPtParallel-Corrected-data-InConeOutConeDPhiCut_ntv6_2.pdf}
...
\PbPb\ data (filled circles) compared to \pp\ data at
  ...
  on the points show the statistical uncertainties.
}
