...
The accelerator complex is shown in Fig.~\ref{fig:pas:intro:lhc}.
...
%ATLAS
The ATLAS detector~\cite{Aad:2008zzm}, shown in Fig.~\ref{fig:pas:intro:atlas} is one of the general-purpose particle physics
...
in the disks.
The SemiConductorTtracker detector (SCT) consists of silicon strips covering out to
...
Beyond $|\eta|=2$, multiwire Cathode Strip Chambers (CSC) with higher granularity
are used.
...
pp and Pb--Pb running.  The Minimum-Bias Trigger Scintillators (MBTS) are
